<?php
    ...
    //     $sql_account="SELECT * FROM tbl_admin WHERE email='".$email."' AND password_admin='".$password_admin."' ";
    ...
    //     if($new_email!=''&&$new_password!=''&&$new_password==$new_password_retype){
    //         $sql_create_account="INSERT INTO tbl_admin(email,username,password_admin,sdt) VALUES('".$new_email."','".$username."','".$new_password."','".$new_password."')";
                    ...
                    <div class="body body__form">
                        <div class="modal__body-signup">
                                ...
                                <div class="modal__body-header--qr">
                                    ...
                                    <div class="modal__body-header--qr__swicht">
                                        <a href="signin__btn.php">
                                            <img width="40px" height="40px" src="assets/img/qr_btn.png" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="modal__body-inner">
                                ...
                                <!-- <button class="auth-form__group-btn" name="login">Đăng Nhập</button> -->
                                <input class="auth-form__group-btn" type="submit" name="login" value="ĐĂNG NHẬP">
                            </div>
                            ...
                            <div class="move-to-signin">
                                ...
                                <a href="create.php" class="swicth-btn">Đăng Ký</a>
                            </div>
                        </div>
